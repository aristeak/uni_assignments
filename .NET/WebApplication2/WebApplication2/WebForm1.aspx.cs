    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack == false) // αν είναι η πρώτη φορά που φορτώνει η σελίδα
            {
                ...
                // οι XML κόμβοι μέσα στη ρίζα είναι της μορφής <item>
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (XmlNode nde in nodes)
            {
                if (nde["currency"].InnerText == n1)
                    ...
                    // η ισοτιμία δίνεται στα διάφορα νομίσματα σε διαφορετικες ποσότητες...
            ...
            if (rateTo != 0){
                f = Math.Round(Convert.ToDecimal(originTb.Text) * rateFrom / rateTo, 2);
